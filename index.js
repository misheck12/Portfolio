...
const cards = [
  {
    key: 0,
    name: 'Afro-Concert',
    option: ['Microverse', 'Front End Dev', '2022'],
    optionMobile: ['CANOPY', 'Back End Dev', '2015'],
    description: 'The project is about Afrotech 2022 global Summit. The website gives information about the event The about-page can be accessed from the homepage with the About link.',
    featuredImage: './images/afrotech.png',
    desktopImage: 'images/afrotech.png',
  ...
  },
  {
    ...
    optionMobile: ['CANOPY', 'Back End Dev', '2015'],
    description: 'Lorem Ipsum lets add simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent ',
...
function showWorks() {
  const works = [
    {
      title: 'Afrotech',
      options: ['Microverse', 'Front End Dev', '2022'],
